...
function StudentAffiliationList (props)
{
    ...
    {
        const name1 = (!('givenName' in pair[0]) || pair[0].givenName === '') ? pair[0].forename : pair[0].givenName; 
        const name2 = (!('givenName' in pair[1]) || pair[1].givenName === '') ? pair[1].forename : pair[1].givenName; 
